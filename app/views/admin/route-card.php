...
if ($method == "GET"):?>
        <a target="_blank" href="../<?= htmlspecialchars($uri) ?>" class="text-xl font-semibold text-gray-800 mb-2 <?= $methodColor ?>"><?= htmlspecialchars($uri) ?></a>
    <?php

else:?>
        <h3 class="text-xl font-semibold text-gray-800 mb-2 <?= $methodColor ?>"><?= htmlspecialchars($uri) ?></h3>
    <?php
