    ...
    <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li><a href="./auth" class="text-gray-400 hover:text-white">SignIn</a></li>
                    <li><a href="./auth/signup" class="text-gray-400 hover:text-white">SignUp</a></li>
                    <li><a href="./sponsor" class="text-gray-400 hover:text-white">Sponsor Project</a></li>
                    <li><a href="./hire" class="text-gray-400 hover:text-white">Hire Developer</a></li>
                </ul>
            </div>
            <div>
